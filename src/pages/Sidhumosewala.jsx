    ...
    return (
        <div className="p-6 bg-gradient-to-br from-black to-red-950 min-h-screen text-white">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
                ...
                />
                <div>
                    <h1 className="text-4xl font-bold">Sidhu mosewala</h1>
                    <p className="mt-2 text-gray-200 max-w-lg">
                        Sidhu Moose Wala was a Punjabi singer, lyricist, and rapper known for his
                        powerful tracks like "295", "So High", and "Legend". His music blended
                        Punjabi folk with modern hip-hop, making him one of the most iconic and
                        influential Punjabi artists.
