...
export default function Pakistani() {
  ...
  if (!Object.keys(singers).length)
    return <div className="text-yellow-400 p-4">No songs found.</div>;

  return (
    <div className="min-h-screen bg-black text-white p-6">
      <h1 className="text-3xl font-bold text-cyan-400 mb-8">
        🎶 Pakistani Singers & Songs
      </h1>

      {Object.entries(singers).map(([singerName, songs]) => (
        <div key={singerName} className="mb-12">
